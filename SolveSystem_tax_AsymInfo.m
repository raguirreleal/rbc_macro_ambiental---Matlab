...
d1 = d1/damage_scale;
d = 1.4151; %The government's policy variable
%}
...
%Eqn 11: Planner's policy option (tau as function of yt-1)
...
%[d_opt,val] = fminsearch(@IRFdiff,d);
...
Cyclematrix = [y_2',e_2',k_2',x_2',tau_2'];
plot(Cyclematrix);
