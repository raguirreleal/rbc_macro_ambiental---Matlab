...
theta2 = 2.8;          % este... da planilha 'Parameters'; célula 'C63' (manteve) - 2.8
gamma  = 1 - 1.07;     % via primeira diferença das séries - 1.07
phic   = 2 ;           % - 2
...
options=optimset('Display','iter','MaxFunEvals',5000,'TolFun',1*10^(-10));  %Não tinha "[,'TolFun',1*10^(-10)]" - padrão é -6
...
%gerar arquivo com as variáveis
